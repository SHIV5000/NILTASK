            ...
            <div id="leftSidebar" class="left-sidebar flex-col border-r z-20 shadow-sm bg-white border-gray-200" style="display: ${leftDisplay}; width: ${leftWidth};">
                <div class="p-4 flex justify-between items-center border-b border-gray-200">
                    ...
                    <div class="flex gap-2">
                        <button onclick="window.toggleTheme()" class="w-8 h-8 rounded-full hover:bg-gray-100 text-gray-500 flex items-center justify-center transition-colors"><i class="fa-solid fa-moon text-sm"></i></button>
            ...
            <div class="flex-1 flex flex-col relative min-w-0 chat-area">
                <div class="p-4 border-b z-10 flex justify-between items-center shadow-sm bg-white/95 backdrop-blur border-gray-200">
                    ...
                    <div class="flex items-center gap-4 text-xl text-gray-500">
                        ...
                        <div class="border-l border-gray-300 pl-4 ml-1 flex gap-3"><i class="ti ti-layout-sidebar-right cursor-pointer hover:text-[var(--accent)] top-bar-icon" onclick="window.toggleRightSidebar()" title="Toggle Task Panel"></i></div>
