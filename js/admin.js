    ...
    <div style="max-width:1100px;margin:0 auto;padding:20px 16px;font-size:14px;">
        ...
        <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:24px;flex-wrap:wrap;gap:12px;">
            <div class="school-badge" style="flex:1;min-width:220px;max-width:420px;">
                ...
                <div class="school-badge-sub">✦ &nbsp; Powered by Noted For Action &nbsp; ✦</div>
            </div>
...
window.printRolesPDF = function() {
    ...
    <div class="foot">Noted For Action · Role-Based Access Control</div>
...
window.printScorecard = function() {
    ...
    <div class="foot">Noted For Action · Objective & Transparent Performance Scoring</div>
    <script>setTimeout(()=>window.print(),400);<\/script></body></html>`);
    w.document.close();
};
