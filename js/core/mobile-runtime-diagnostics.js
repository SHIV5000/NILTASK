    ...
    function snapshot() {
        ...
        return {
            ...
            unread: unread ? {
                ...
                adaptersInstalled: unread.mobileAdaptersInstalled,
                usesSharedRefresh: unread.mobileUsesSharedRefresh,
                usesExistingQueries: unread.mobileUsesExistingQueries,
                ownsPoll: unread.mobileOwnsPolling,
                ownsRendering: unread.mobileOwnsRendering,
                ownsAppBadge: unread.mobileOwnsAppBadge,
                renderPassive: unread.mobileRenderPassive,
                roomAdapterCalls: unread.mobileRoomObservations,
                attentionAdapterCalls: unread.mobileAttentionObservations,
                refreshCount: unread.mobileRefreshCount,
                coalescedCalls: unread.mobileCoalescedCalls,
                eventConsumedAt: unread.mobileEventConsumedAt,
            ...
            acceptance: {
                ...
                sharedUnreadUsesOneRefresh: Boolean(unread?.mobileUsesSharedRefresh),
                sharedUnreadBypassesIndependentQueries: unread ? unread.mobileUsesExistingQueries === false : false,
                sharedUnreadHasNoOwnPoll: unread ? unread.mobileOwnsPolling === false : false,
                sharedUnreadHasNoOwnRenderer: unread ? unread.mobileOwnsRendering === false : false,
                sharedUnreadHasNoOwnAppBadge: unread ? unread.mobileOwnsAppBadge === false : false,
                sharedUnreadEventConsumed: Boolean(unread?.mobileEventConsumedAt),
            ...
            limitations: [
                'The existing mobile fallback/realtime cadence invokes two compatibility calls that coalesce through one UnreadService refresh.',
                'mobile.js still owns live provisional increments, open-room zeroing, surgical row rendering and OS app-badge writes.',
